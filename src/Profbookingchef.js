...
var lat, lng;
var category
class Profbookingchef extends Component {
    constructor(props) {
        super(props)
    ...
    handleClick = e => {
        ...
        axios({
            method: 'post',
            url: 'http://localhost:5000/bookchef/disprof',
            data: params
        })
            .then(res => {
                const mdis = res.data;
    ...
    handleAccept(book_id,Owner,category,price){
        ...
        axios({
            method: 'post',
            url: 'http://localhost:5000/bookchef/accept',
            data: params
        })
            .then(res => alert(res.data));
    ...
    handleReject(book_id,Owner,category,price){
        ...
        axios({
            method: 'post',
            url: 'http://localhost:5000/bookchef/reject',
            data: params
        })
            .then(res => alert(res.data));
        ...
        return this.state.mdis.map(ds => {
            ...
            return (
                <tr key={ds._id}>
                    ...
                    {/* <td><button type="button" className="btn btn-outline-info btn-block" onClick={()=> this.handleAccept(ds._id,ds.Owner,ds.category,ds.discount)}>Accept</button></td>
...
export default Profbookingchef